    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
          ...
          <div class="row">
							<div class="modal-body">
								<?= $this->session->flashdata('message'); ?>
									...
									Anda tercatat pernah mendaftar <b>Seminar Proposal</b>.
								...
								<div class="col-lg-12 modal-footer d-flex flex-row justify-content-center mt-auto pt-3"
									style="background-color: #e4e4f4; border-radius:0;">Klik tombol berikut untuk melakukan pendaftaran <i
								...
								<?php } else if($user['status'] == 1) { ?>
								<div class="col-lg-12 modal-footer d-flex flex-row justify-content-center mt-auto pt-3"
									style="background-color: #e4e4f4; border-radius:0;">Pendaftaran <b>Seminar Proposal</b>anda telah disetujui
								</div>
								...
								<!-- PEMBATALAN PENDAFTARAN SEMPRO -->
									<?php } else if ($user['status'] == 2) { ?>
									<div class="col-lg-12 modal-footer d-flex flex-row justify-content-center mt-auto pt-3"
										style="background-color: #e4e4f4; border-radius:0;">Klik tombol berikut untuk membatalkan pendaftaran<i
											class="fas fa-fw fa-arrow-right"></i>
										<button type="button" class="btn btn-danger" data-toggle="modal"
											data-target="#batalDaftarSemproModal">
								...
								<!-- PEMBATALAN PENDAFTARAN SIDANG -->
									...
									<div class="col-lg-12 modal-footer d-flex flex-row justify-content-center mt-auto pt-3"
										style="background-color: #e4e4f4; border-radius:0;">Klik tombol berikut untuk membatalkan pendaftaran<i
											class="fas fa-fw fa-arrow-right"></i>
										<button type="button" class="btn btn-danger" data-toggle="modal"
											data-target="#batalDaftarSidangModal">
											Batalkan Pendaftaran</button>
									</div>
								</div>
									...
									<?php } else if($user['status'] == 5) { ?>
									<div class="col-lg-12 modal-footer d-flex flex-row justify-content-center mt-auto pt-3"
											style="background-color: #e4e4f4; border-radius:0;">Pendaftaran <b>Sidang Akhir</b>anda telah disetujui. Selamat anda telah selesai menyelesaikan semua misi. Good luck for next journey!
										<?php } ?>
									</div>
            	</div>
            </div>
        ...
        <div class=" modal fade" id="DaftarSemproModal" tabindex="-1" aria-labelledby="addDaftarSemproLabel"
          aria-hidden="true">
        ...
        <div class=" modal fade" id="DaftarSidangModal" tabindex="-1" aria-labelledby="addDaftarSidangLabel"
          aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
        ...
        <div class="modal fade" id="batalDaftarSemproModal" tabindex="-1" aria-labelledby="batalDaftarSemproLabel"
          aria-hidden="true">
                ...
                <div class="modal-body">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i
                        class="fas fa-fw fa-times"></i> No</button>
