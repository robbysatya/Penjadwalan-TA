...
class User_model extends CI_Model
{
  ...
  public function save_daftar_sidang()
  {
    ...
    if (!empty($_FILES['file_persetujuan'])) {
      ...
      $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Daftar gagal file masih ada yang kurang!</div>');
  ...
  public function batal_daftar_sidang()
  {
    ...
    $this->db->set('file_draft', null);
    $this->db->set('file_ppt', null);
    $this->db->set('file_persetujuan', null);

    $this->db->set('judul', null);
    $this->db->set('topik', null);
    $this->db->set('keahlian_id', null);
    $this->db->set('id_jenis_ujian', null);
    $this->db->set('dosbim_1', null);
    $this->db->set('dosbim_2', null);
